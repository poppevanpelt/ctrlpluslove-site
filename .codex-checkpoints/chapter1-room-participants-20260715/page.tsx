...
const roomEntries = [
  {
    ...
    numberClass: "confidence-shift-one",
    before: "82%",
    after: "68%",
  ...
  },
  {
    ...
    numberClass: "confidence-shift-two",
    before: "68%",
    after: "51%",
  ...
  },
  {
    ...
    numberClass: "confidence-shift-three",
    before: "51%",
    after: "91%",
    ...
    <main className="site-shell chapter-one" id="main-content">
              ...
              >
                ...
                <dl>
                  ...
                  <div>
                    <dt>After</dt>
                    <dd>
                      <span className={`confidence-shift ${entry.numberClass}`}>
                        <span className="confidence-from">{entry.before}</span>
                        <span className="confidence-to">{entry.after}</span>
                      </span>
                    </dd>
                  </div>
                </dl>
      ...
      >
        <div className="content-block verdict-block">
          ...
          <h2
            className="sequence-reveal sequence-final-verdict"
            id="verdict-title"
          >
            Delay launch.
            <br />
          ...
          <dl
            className="verdict-metrics sequence-reveal sequence-final-verdict"
            aria-label="Final verdict metrics"
          >
            <div>
              <dt>Confidence</dt>
              <dd>91%</dd>
          ...
          <p className="verdict-rule sequence-reveal sequence-reality-rule">
