  ...
  return (
    <main className={styles.page}>
      ...
      <section className={styles.hero}>
        <picture><source media="(max-width: 900px)" srcSet="/2go-assets/handoff.webp?v=20260921c" /><img src="/2go-assets/hero.webp?v=20260921c" alt="ctrl+2go drive-through at night in the rain" className={styles.heroImage} /></picture>
      ...
      <section className={styles.world}>
        <figure><img src="/2go-assets/speaker.webp?v=20260921c" alt="ctrl+2go order speaker in the rain" /><figcaption>TALK TO US.</figcaption></figure>
        <figure><img src="/2go-assets/extras.webp?v=20260921c" alt="ctrl+2go extra solutions" /><figcaption>CLEAR. DOUBT. NOPE. MAYBE. YES.</figcaption></figure>
        <figure><img src="/2go-assets/hero.webp?v=20260921c" alt="ctrl+2go drive-through" /><figcaption>CONSULTANTS LEFT ON PREMISES — 0.</figcaption></figure>
      </section>
      ...
      <section className={styles.extraGrid}>
        ...
        <img src="/2go-assets/extras.webp?v=20260921c" alt="ctrl+2go extra solutions on a wet stainless counter" />
      </section>
