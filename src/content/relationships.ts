...
export const signals: RelatedContent[] = [
  ...
  },
  {
    ...
    title: "Trust is the scaling layer",
    summary:
      "A network signal on why trusted people carry cultural nuance better than centralised scripts.",
    status: "published",
    publishedAt: "2026-07-18",
    relatedEmbassies: ["EMB-002"],
    participants: ["Mats Utberg"],
  },
];
...
export const conversations: RelatedContent[] = [
  {
    ...
    summary:
      "The opening conversation for the Embassy Network and its first two permanent IDs.",
    status: "published",
    publishedAt: "2026-07-18",
    relatedEmbassies: ["EMB-001", "EMB-002"],
    participants: ["Shun Iwai", "Mats Utberg"],
  },
];
